...
<script type="text/javascript">
	function delete_id(id)
	{
		...
		if(r== true)
		{
			window.location.href='delete.php?tbl=trustee_detail& delete_id='+id;	
		}
...
$rec4=$obj4->sel($start,$limit);
			...
			<div id='page-wrapper'>
				<div class='graphs'>
					<h3 class='blank1'>Trustee List</h3>
		...
		while ($result1=mysqli_fetch_array($rec1)) 
		{
			...
			$data.="
										<tr>
											...
											<td>".$result4[1]."</td>
											<td>".$result4[3]."</td>
											<td width='25%'>".$result4[4].",".$result1[1].",".$result2[1]."</td>
											<td>".$result4[6]."</td>
											<td>".$result4[7]."</td>
											<td><a href='edittrustee.php?Id1=".$result4[0]."&Id=".$result[0]."'><i class='fa fa-pencil'></i> </a></td>
