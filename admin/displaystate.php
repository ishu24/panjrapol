...
<script type="text/javascript">
	function delete_id(id)
	{
		...
		if(r== true)
		{
			window.location.href='delete.php?tbl=state_detail& delete_id='+id;	
		}
						...
						<div class='tab-pane active' id='horizontal-form'>
							...
							<div class='panel-body no-padding'>
								...
								<div class='col-sm-1 col-sm-offset-11'>
									<a href='addstate.php'><button class='btn-warning btn'>ADD</button></a>
...
while($result=mysqli_fetch_array($rec))
{
			...
			$data.="						<tr>
											<td>".$i++."</td>
											<td>".$result[1]."</td>
											<td><a href='addstate.php?Id=".$result[0]."'><i class='fa fa-pencil'></i></a></td>
