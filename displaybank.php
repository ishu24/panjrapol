...
<script type="text/javascript">
	function delete_id(id)
	{
		...
		if(r== true)
		{
			window.location.href='delete.php?tbl=bank_detail& delete_id='+id;	
		}
	...
	while ($result=mysqli_fetch_array($rec))
	 {
			...
			$data.="
										<tr>
											...
											<td>".$result4[4]."</td>
											<td>".$result4[5]."</td>
											<td><a href='editbank.php?Id1=".$result4[0]."&Id=".$result[0]."'><i class='fa fa-pencil'></i> </a></td>
